...
export default function AdminStudyTemplatePage() {
    ...
    const [template, setTemplate] = useState<AdminStudyTemplate | null>(null);
                ...
                >
                    <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
                        <div style={{ ...cardStyle, padding: "18px" }}>
                            <h2 style={{ marginTop: 0 }}>Vad ska eleven lära sig?</h2>

                            <textarea
                                value={data.goal}
                                onChange={(event) => updateGoal(event.target.value)}
                                rows={4}
                                placeholder="Skriv vad eleven ska kunna efter passet..."
